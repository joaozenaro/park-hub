        ...
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Portal>
            <DropdownMenu.Content
              ...
              sideOffset={8}
            >
              <DropdownMenu.Item className="text-slate-500 px-2 text-sm leading-4 rounded-md flex items-center h-8 select-none outline-none data-[highlighted]:bg-slate-100 data-[highlighted]:text-zinc-900">
